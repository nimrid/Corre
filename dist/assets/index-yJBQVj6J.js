import{i as N,a as k,x as a,r as L,e as v,D as p,d as O,R as Y,O as V,f as z,A as E,W}from"./index-39LmfiTE.js";import{n as l,c as _,o as j,r as b}from"./if-defined-DG08lccF.js";import{T as A,D as F}from"./index-Ct7b0up3.js";import"./index-Go-RI6QP.js";import"./index-AtSPTo37.js";import"./index-B_O6BnpT.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
